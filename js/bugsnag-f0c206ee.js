...
(r.exports = (function () {
  var e = [
    ...
    s = function (e) {
      ...
      for (var r = 0, a = i.length; r < a; r++)
        Object.prototype.hasOwnProperty.call(e, i[r]) && n.push(i[r]);
      return n;
    },
    u = function (e, t) {
      return (
    ...
    return {
      ...
      parseOpera9: function (t) {
        for (
          ...
          var s = n.exec(r[o]);
          s &&
            a.push(new e({ fileName: s[2], lineNumber: s[1], source: r[o] }));
        }
        return a;
      },
    ...
    return {
      backtrace: function (t) {
        ...
        for (var a = arguments.callee; a && n.length < r && a.arguments; ) {
          for (var o = new Array(a.arguments.length), i = 0; i < o.length; ++i)
            o[i] = a.arguments[i];
  ...
  var G = (function () {
      ...
      return (
        ...
        (t.addFeatureFlag = function (e, t) {
          void 0 === t && (t = null),
            H.add(this._features, this._featuresIndex, e, t);
        }),
    ...
    Q = function (e) {
      ...
      return (
        t.lineNumber > -1 && !t.file && !t.method && (t.file = "global code"), t
      );
    },
    Y = function (e) {
  ...
  (G.getStacktrace = function (e, t, r) {
    ...
    (G.create = function (e, t, n, r, a, o) {
      ...
      if (
        ("InvalidError" === u.name &&
          i.addMetadata("" + r, "non-error parameter", re(e)),
        u.cause)
      ) {
        var f,
          d = ne(u).slice(1),
          g = h(d, function (e) {
            ...
            return (
              "InvalidError" === n.name && i.addMetadata("error cause", re(e)),
              te(n.name, n.message, G.__type, t)
            );
          });
    ...
    ae = function (e, t, n, r) {
      var a,
        ...
        i = function (e) {
          ...
          var a = new Error(
            n + " " + t + ' a non-error. See "' + n + '" tab for more detail.'
          );
        ...
        switch (typeof e) {
          ...
          case "object":
            null !== e && U(e)
              ? (a = e)
              : null !== e && oe(e)
              ? (((a = new Error(e.message || e.errorMessage)).name =
                  e.name || e.errorClass),
                (o += 1))
    ...
    ce = function (e, t, n, r) {
      for (var a = !1, o = e.slice(); !a && o.length; )
        try {
          ...
          r.error(
            "Error occurred in " + n + " callback, continuing anyway\u2026"
          ),
            r.error(e);
        }
      return a;
  ...
  var he = navigator.mimeTypes ? navigator.mimeTypes.length : 0,
    pe = le(
      (he + navigator.userAgent.length).toString(36) + de.toString(36),
      4
    ),
    ve = function () {
      return pe;
  ...
  function Ee() {
    return (
      "c" +
      new Date().getTime().toString(be) +
      le(we().toString(be), ye) +
      ve() +
      (Se() + Se())
    );
  }
    ...
    Re = (function () {
      ...
      return (
        ...
        (o.addFeatureFlag = function (e, t) {
          void 0 === t && (t = null),
            Ne(this._features, this._featuresIndex, e, t);
        }),
        ...
        (o._configure = function (e, n) {
          ...
          return (
            (this._metadata = g({}, i.metadata)),
            Te(this._features, i.featureFlags, this._featuresIndex),
            (this._user = g({}, i.user)),
            (this._context = i.context),
            i.logger && (this._logger = i.logger),
            i.onError && (this._cbs.e = this._cbs.e.concat(i.onError)),
            i.onBreadcrumb &&
              (this._cbs.b = this._cbs.b.concat(i.onBreadcrumb)),
            i.onSession && (this._cbs.s = this._cbs.s.concat(i.onSession)),
            s(o).length && this._logger.warn(Be(o, e)),
            i
          );
        }),
        (o.getUser = function () {
        ...
        (o.startSession = function () {
          ...
          return (
            ...
            ce(this._cbs.s, e, "onSession", this._logger)
              ? (this._logger.debug(
                  "Session not started due to onSession callback"
                ),
                this)
        ...
        (o.leaveBreadcrumb = function (t, n, a) {
          if (
            ...
            var o = new S(t, n, a);
            ce(this._cbs.b, o, "onBreadcrumb", this._logger)
              ? this._logger.debug(
        ...
        (o._notify = function (e, t, n) {
          ...
          if (
            ...
            (e._metadata = g({}, e._metadata, this._metadata)),
            (e._user = g({}, e._user, this._user)),
            (e.breadcrumbs = this._breadcrumbs.slice()),
            Te(e._features, this._features, e._featuresIndex),
          ...
          ue(u, e, s, function (t, r) {
            if ((t && s(t), !r))
              return (
                o._logger.debug("Event not sent due to onError callback"),
                n(null, e)
              );
            o._isBreadcrumbTypeEnabled("error") &&
              ...
              i !== e.severity &&
                (e._handledState.severityReason = {
  ...
  (Ae.event = function (e, t) {
    ...
    if (
      ...
      (n = j(e, null, null, { redactedPaths: Ce, redactedKeys: t })).length >
        1e6)
    )
  ...
  var De = function (e, t, n, r) {
      ...
      return (
        Pe(e.endpoints[t], r.location.protocol) +
        "?apiKey=" +
  ...
  var ze = navigator.mimeTypes ? navigator.mimeTypes.length : 0,
    Ge = Ue(
      (ze + navigator.userAgent.length).toString(36) + Je.toString(36),
      4
    ),
    Qe = function () {
      return Ge;
  ...
  function at() {
    return (
      "c" +
      new Date().getTime().toString(et) +
      Ue(rt().toString(et), Ze) +
      Qe() +
      (nt() + nt())
    );
  }
    ...
    st = function () {
      try {
        var e = window.localStorage,
          t = e.getItem(it);
        return (
          (t && /^c[a-z0-9]{20,32}$/.test(t)) || ((t = ot()), e.setItem(it, t)),
          t
        );
      } catch (e) {}
    },
            ...
            t && t.orientation && t.orientation.type
              ...
              n.addOnSession(function (e) {
                (e.device = g({}, e.device, r)),
                  n._config.collectUserIp || ct(e);
              }),
              n.addOnError(function (e) {
                (e.device = g({}, e.device, r, { time: new Date() })),
                  n._config.collectUserIp || ct(e);
              }, !0);
          },
          configSchema: {
          ...
          load: function (t) {
            t.addOnError(function (t) {
              (t.request && t.request.url) ||
                (t.request = g({}, t.request, { url: e.location.href }));
            }, !0);
          },
        }
      );
    ...
    dt = {
      startSession: function (e, t) {
        ...
        return (
          ...
          r(n._config.enabledReleaseStages, n._config.releaseStage)
    ...
    gt = {
      load: function (e) {
        e._config.collectUserIp ||
          e.addOnError(function (e) {
            e._user && void 0 === e._user.id && delete e._user.id,
              (e._user = g({ id: "[REDACTED]" }, e._user)),
              (e.request = g({ clientIp: "[REDACTED]" }, e.request));
          });
      },
      configSchema: {
        collectUserIp: {
          ...
          load: function (a) {
            if (a._config.trackInlineScripts) {
              ...
              var l = null,
                ...
                g = function (e) {
                  ...
                  return t(
                    ...
                    function (e, t, n) {
                      return (
                        (e[a + 1 + n] = t.length <= vt ? t : t.substr(0, vt)), e
                      );
                    },
                    {}
                  );
              ...
              a.addOnError(function (e) {
                e.errors[0].stacktrace = n(
                  e.errors[0].stacktrace,
                  function (e) {
                ...
                if (
                  ...
                  if (r) {
                    ...
                    e.addMetadata(
                      "script",
                      "content",
                      a.length <= mt ? a : a.substr(0, mt)
                    ),
                      t && t.lineNumber && (t.code = g(t.lineNumber));
                  }
                }
              }, !0);
              var p = h(
              ...
              return (
                ...
                function () {
                  ...
                  try {
                    var a = t(r),
                      o = a.get();
                    if ((n && e.apply(this, r), "function" != typeof o))
        ...
        if (
          ...
          e.addEventListener("pagehide", n("Page hidden"), !0),
            ...
            e.addEventListener(
              ...
              function (n) {
                var r = n.oldURL
                  ? { from: xt(n.oldURL, e), to: xt(n.newURL, e), state: Tt(e) }
                  : { to: xt(e.location.href, e) };
  ...
  var xt = function (e, t) {
      ...
      var n = {
        load: function (n) {
          if (n._isBreadcrumbTypeEnabled("request")) {
            var a = [
              n._config.endpoints.notify,
              n._config.endpoints.sessions,
            ].concat(e);
            s(), l();
            var o = function (e, t, r) {
                var a = { status: e.status, request: t + " " + r };
                e.status >= 400
                  ? n.leaveBreadcrumb("fetch() failed", a, Lt)
                  : n.leaveBreadcrumb("fetch() succeeded", a, Lt);
              },
              i = function (e, t) {
                n.leaveBreadcrumb(
                  "fetch() error",
          ...
          function s() {
            if ("addEventListener" in t.XMLHttpRequest.prototype) {
              ...
              t.XMLHttpRequest.prototype.open = function (t, n) {
                ...
                a &&
                  (this.removeEventListener("load", i),
          ...
          function u(e, t, o) {
            if (void 0 !== t) {
              if ("string" != typeof t || !r(a, t.replace(/\?.*$/, ""))) {
                ...
                o >= 400
                  ? n.leaveBreadcrumb("XMLHttpRequest failed", i, Lt)
                  : n.leaveBreadcrumb("XMLHttpRequest succeeded", i, Lt);
              }
            } else
              n._logger.warn(
    ...
    At = function (e) {
      return (
        void 0 === e && (e = window),
        {
          load: function (t) {
            if (
              t._config.autoDetectErrors &&
              t._config.enabledErrorTypes.unhandledExceptions
            ) {
              var n = e.onerror;
              e.onerror = r;
            }
            function r(e, r, a, o, i) {
              if (0 === a && /Script error\.?/.test(e))
                t._logger.warn(
                ...
                if (i)
                  (s = t.Event.create(i, !0, u, "window onerror", 1)),
                    Ct(s.errors[0].stacktrace, r, a, o);
                else if (
                  "object" != typeof e ||
                  null === e ||
                  (r && "string" == typeof r) ||
                  ...
                  (s = t.Event.create(e, !0, u, "window onerror", 1)),
                    Ct(s.errors[0].stacktrace, r, a, o);
                else {
    ...
    Ct = function (e, t, n, r) {
      ...
      a.file || "string" != typeof t || (a.file = t),
        !a.lineNumber && It(n) && (a.lineNumber = n),
        a.columnNumber ||
          (It(r)
            ? (a.columnNumber = r)
            : window.event &&
              It(window.event.errorCharacter) &&
      ...
      return (
        void 0 === e && (e = window),
        {
          load: function (t) {
            if (
              t._config.autoDetectErrors &&
              t._config.enabledErrorTypes.unhandledRejections
            ) {
              var n = function (e) {
                var n = e.reason,
                  r = !1;
                try {
                  e.detail &&
                    e.detail.reason &&
                    ((n = e.detail.reason), (r = !0));
                } catch (e) {}
                var a = t.Event.create(
                  n,
                  !1,
                  {
                    severity: "error",
    ...
    Ut = {
      ...
      createClient: function (e) {
        ...
        return (
          n._setDelivery(window.XDomainRequest ? Ie : Ve),
      ...
      start: function (e) {
        return Ut._client
          ? (Ut._client._logger.warn(
              "Bugsnag.start() was called more than once. Ignoring."
            ),
            Ut._client)
          : ((Ut._client = Ut.createClient(e)), Ut._client);
      },
      isStarted: function () {
    ...
    h(["resetEventCount"].concat(s(Me.prototype)), function (e) {
      /^_/.test(e) ||
        (Ut[e] = function () {
          if (!Ut._client)
            return console.log(
              "Bugsnag." + e + "() was called before Bugsnag.start()"
            );
          Ut._client._depth += 1;
  ...
  window.Bugsnag.start({
    ...
    appVersion: `new-${window.CACHE_NAME}`,
    metadata: { lang: document.documentElement.dataset.wiki },
  });
