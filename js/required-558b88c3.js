...
async function n(e, n) {
  ...
  this.in_progress ||
    (this.property_fetcher = new Promise((e, t) =>
      fetch(a)
        .then((e) => {
  ...
  return (
    (this.cached_properties = this.cached_properties.map((e, t) =>
      Object.assign(this.cached_properties[t], o[t])
    )),
...
let i = new (class {
  constructor() {
    ...
    document.documentElement.lang.split("-")[0]
      ...
      (this.local_states = (function () {
        ...
        return (
          document
            .querySelectorAll("#StateOfMatter > div > dd")
            .forEach(
              (t) =>
                (e[t.previousElementSibling.classList.value] = t.textContent)
            ),
          e
        );
      })()),
      (this.local_series = (function () {
        ...
        return (
          document
            ...
            .forEach((t) => (e[t.classList.value] = t.textContent)),
          e
        );
      })()),
      (this.local_decaymodes = (function () {
        ...
        return (
          document
            .querySelectorAll("#DecayModes > * > dt")
            .forEach((t) =>
              t.classList.forEach(
                (n) => (e[n] = t.nextElementSibling.textContent)
              )
            ),
          e
        );
      ...
      document
        ...
        .forEach(
          (e) =>
            (e.textContent = Number(e.dataset.num).toLocaleString(this.locale))
        ),
      (this.isotope_properties = []),
      (this.activeProperty =
        ".Reset #Reset input:checked, .Property #Property input:checked, .Electron #Electron input:checked, .Isotope #Isotope input:checked, .Compound #Compound input:checked"),
      (this.hoverElement = new Event("hoverElement", { bubbles: !0 })),
      (this.activateElement = new Event("activateElement", { bubbles: !0 })),
      (this.deactivateElement = new Event("deactivateElement", {
        bubbles: !0,
      })),
      (this.changeProperty = new Event("changeProperty", { bubbles: !0 })),
      (this.recolorTable = new Event("recolorTable", { bubbles: !0 })),
  ...
  value(e, t, n) {
    return !1 !== t &&
      "isotopes" !== n &&
      document.querySelector(`[name="isotopes"][value="${n}"]`)
      ? o.call(this, e, t, n)
      : a.call(this, e, n);
  }
  insert(e, t, n) {
...
let s, c;
const l = {
  to: { F: (e) => 1.8 * (e - 273.15) + 32, C: (e) => e - 273.15, K: (e) => e },
  from: {
    F: (e) => (5 / 9) * (e - 32) + 273.15,
    C: (e) => e + 273.15,
    K: (e) => e,
      ...
      (async function (e) {
        ...
        function o(e) {
          ...
          i.atomic_map.forEach((o, r) => {
            const s = t(e, n[r], a[r]);
            i.insert(r, "state", { C: s, K: s, F: s }),
              o.classList.contains(s) ||
                (o.classList.remove("Solid", "Liquid", "Gas", "UnknownState"),
                o.classList.add(s));
          });
        }
        ...
        [
          ...
          document
            .querySelector("input[value=state] + li > output")
            .dispatchEvent(i.updateOutput),
          r("PropertyClass").classList.contains("state") &&
            r("Property").dispatchEvent(i.changeProperty);
        (r("PropertyClass").classList.contains("melt") ||
          r("PropertyClass").classList.contains("boil")) &&
          document
            .querySelector("#Property input:checked")
            .dispatchEvent(i.recolorTable);
      })(e)
    ));
}
function d() {
...
(r("Temperature").oninput =
  r("TempRange").oninput =
  r("Celsius").oninput =
  r("Fahrenheit").oninput =
  r("Kelvin").oninput =
    u),
  ...
  h = {
    ...
    decaymode: function (e, t) {
      switch (t) {
        case "aside":
        case "weight":
          i.local_decaymodes[e]
            ? (e = i.local_decaymodes[e])
            : e && (e = e.split(/(?=[A-Z])/).join(" "));
      }
      return e;
    },
        ...
        case "weight":
          e = f(
            (e = e
              .split(",")
              .filter((e) => "c" === e.slice(-1))
              .map((e) => Number(e.slice(0, -1)).toLocaleString(i.locale))),
            "narrow"
          );
          break;
        case "aside":
          (e = f(
            (e = e
              ...
              .map((e) =>
                "c" === e.slice(-1)
                  ? "<b>" +
                    Number(e.slice(0, -1)).toLocaleString(i.locale) +
                    "</b>"
                  : Number(e).toLocaleString(i.locale)
              )),
            "short"
          )),
            (e = document.createRange().createContextualFragment(e));
    ...
    quantum: function (e, t) {
      switch (t) {
        ...
        case "aside":
          e = f(
            (e = [
              `\u{1d459}=${e.l.toLocaleString(i.locale)}`,
              `\u{1d45a}=${e.m.toLocaleString(i.locale)}`,
              `\u{1d45b}=${e.n.toLocaleString(i.locale)}`,
            ]),
            "short"
          );
          break;
    ...
    electronstring: function (e, t) {
      switch (t) {
        ...
        case "aside":
          (e = e
            .split(" ")
            .map((e) => e.replace(/[spdf]\d+/, (e) => g(e, "sup")))
            .join(" ")),
            (e = document.createRange().createContextualFragment(e));
          break;
        case "gradient":
    ...
    discover: function (e, t) {
      ...
      switch (t) {
        case "weight":
          e = n.toLocaleString(i.locale, { year: "numeric", era: "narrow" });
          break;
        case "aside":
          e = n.toLocaleString(i.locale, { year: "numeric", era: "short" });
      }
      return e;
    },
    isotopes: function (e, t) {
      if ("gradient" === t) if (e) return "MATCHES";
      return e;
    },
...
function f(e, t) {
  if ("ListFormat" in Intl)
    return new Intl.ListFormat(i.locale, { type: "unit", style: t }).format(e);
  {
    const n = { short: ", ", narrow: " " };
    return e.join(n[t]);
  }
}
function g(e, t) {
  ...
  return String(e)
    .split("")
    .map((e) => (e in n[t] ? String.fromCodePoint(n[t][e]) : e))
    .join("");
}
function v(e, t, n = { style: "decimal" }) {
  const a = 1e-5,
    o = 1e6;
  (((e = Number(e)) < a && e > 0) ||
    (e > -1e-5 && e < 0) ||
    e > o ||
    e < -1e6) &&
    ((n.minimumSignificantDigits = n.maximumSignificantDigits = Math.min(t, 5)),
    (n.notation = "scientific"));
  let r = e.toLocaleString(i.locale, n);
  const s = void 0 !== window.safari;
  return "scientific" === n.notation && s && (r = e.toExponential(t - 1)), r;
}
function E(e, t, n) {
  ...
  let o = (function (e) {
    ...
    if (
      "object" != typeof e &&
      "undefined" !== e &&
      ((t = e), !isNaN(parseFloat(t)) && isFinite(t))
    )
      return 0 == (n = e)
        ? 1
        : (n = String(n))
  ...
  const i = (function (e) {
    return [...e.closest("li").querySelectorAll(":scope > select")].find(
  ...
  if (
    ((t = (function (e, t) {
      ...
      return (
        null != e &&
          t?.value in n &&
          (t.querySelector("[value=auto]") &&
            "false" !== t.dataset.auto &&
            (t.value = (function (e) {
              const t = {
                y: 31556926,
                d: 86400,
              ...
              for (let n in t) if (e >= t[n]) return n;
              return "ps";
            })(e)),
          (e = t.classList.contains("Half-Life")
            ? { unit: t.value, converted: n[t.value](e), raw: e }
            : n[t.value](e))),
        e
      );
    })(t, i)),
    ...
    const e = { minimumSignificantDigits: o, maximumSignificantDigits: o };
    "object" == typeof t
      ? (t.converted = v(t.converted, o, e))
      : (t = v(t, o, e));
  }
...
async function y(e, t) {
  ...
  if (
    "isotopes" !== e.value &&
    document.querySelector(`[name="isotopes"][value="${e.value}"]`)
  ) {
  ...
  const o = { series: "abridged" }[e.value] || e.value,
...
function b(e) {
  let t = e
    .split(" ")
    .reduce((e, t) => e + Number(t.replace(/^\d+[spdf](\d+)$/, "$1")), 0);
  const n = [];
  for (let e = 1; e <= 8; e++)
    for (let t = Math.floor((e - 1) / 2), a = e - t; t >= 0; t--, a++)
      n.push({ n: a, l: t });
  const a = n
      .map((e) => {
        const n = 4 * e.l + 2,
...
async function C(e) {
  ...
  const n = Number(t.dataset.atomic),
    ...
    o = w("CloseUp");
  if (
    ((o.getElementsByTagName("b")[0].textContent = n.toLocaleString(i.locale)),
    o
      .getElementsByTagName("abbr")[0]
      .replaceWith(t.getElementsByTagName("abbr")[0].cloneNode(!0)),
    (o.querySelector("em > a").textContent = a.name),
    (o.getElementsByTagName("em")[0].style.cssText =
      t.getElementsByTagName("em")[0].style.cssText),
  ...
  if (a.electrons) {
    const e = o.getElementsByTagName("small")[0].children,
      t = a.electrons;
    [...e].forEach(
      (e, n) => (e.textContent = t[n] ? t[n].toLocaleString(i.locale) : "\xa0")
    );
  }
}
w("Ptable").addEventListener("hoverElement", (e) => {
  cancelAnimationFrame(S), (S = requestAnimationFrame(() => C(e)));
}),
...
T?.toLowerCase() !== N.toLowerCase() &&
  Math.random() < 0.1 &&
  (reportError({ name: "Spacer", message: document.domain }),
  (new Image().src =
    "//" + N + "." + String.fromCharCode(67, 79, 77) + "/favicon.ico?"));
const k = (e) => document.getElementById(e),
  $ = document.documentElement.dataset.wiki,
  q = { atomic: !1, isotope: !1 };
let P;
function A(e) {
  const t = e.target;
  (q.atomic = Number(t.dataset.atomic)),
    ...
    document
      .querySelectorAll("aside li > output")
      .forEach((e) => e.dispatchEvent(i.updateOutput));
}
function I() {
...
function M() {
  document.querySelectorAll(`select [value="${this.value}"]`).forEach((e) => {
    ...
    const t = e.closest("select").previousElementSibling,
      n = t.closest("li");
    n.previousElementSibling?.checked &&
      n.closest("ul").dispatchEvent(i.changeProperty),
...
async function _() {
  ...
  this.classList.toggle("Unknown", null == t),
    null == t
      ...
      : "object" == typeof t
      ? ((this.textContent = ""), this.appendChild(t))
      : (this.textContent = t);
}
async function F() {
...
function D(e) {
  ...
  t.disabled
    ? (k("Ptable").classList.add("FlashPlaceholder"),
      setTimeout(() => k("Ptable").classList.remove("FlashPlaceholder"), 200))
    : (this.previousElementSibling.checked = !0),
    this.previousElementSibling.focus(),
    this.closest("ul").dispatchEvent(new CustomEvent("change", { detail: n }));
}
document
  .querySelectorAll("aside li")
  .forEach((e) => e.addEventListener("click", D)),
  document
    .querySelectorAll("aside label > select")
    .forEach((e) => e.addEventListener("change", I)),
  document
    .querySelectorAll("aside li > output")
    .forEach((e) => e.addEventListener("updateOutput", _)),
  ...
  document
    .querySelectorAll("aside li > select, .Temperature")
    .forEach((e) => e.addEventListener("change", M)),
  document
    .querySelector("aside li > select.Half-Life")
    .addEventListener(
      "change",
      (e) => (e.target.dataset.auto = "auto" === e.target.value)
    ),
  k("Ptable").addEventListener("activateElement", A),
  k("Ptable").addEventListener("hoverElement", (e) => {
    cancelAnimationFrame(P), (P = requestAnimationFrame(() => A(e)));
  });
const O = {
  activate: function () {
  ...
  return (
    ...
    (t = X.exec(e))
      ? ((n = t[1].length),
        (t = parseInt(t[1], 16)),
        6 === n
          ? new re(((a = t) >> 16) & 255, (a >> 8) & 255, 255 & a, 1)
          : 3 === n
          ? new re(
              ((t >> 8) & 15) | ((t >> 4) & 240),
              ((t >> 4) & 15) | (240 & t),
      ...
      : (t = Y.exec(e))
      ? new re((255 * t[1]) / 100, (255 * t[2]) / 100, (255 * t[3]) / 100, 1)
      : (t = Z.exec(e))
      ? oe(t[1], t[2], t[3], t[4])
      : (t = J.exec(e))
      ? oe((255 * t[1]) / 100, (255 * t[2]) / 100, (255 * t[3]) / 100, t[4])
      : (t = Q.exec(e))
      ? me(t[1], t[2] / 100, t[3] / 100, 1)
      : (t = ee.exec(e))
      ? me(t[1], t[2] / 100, t[3] / 100, t[4])
      : "transparent" === e
...
function oe(e, t, n, a) {
  return a <= 0 && (e = t = n = NaN), new re(e, t, n, a);
}
function ie(e) {
  return (
    e instanceof H || (e = ae(e)),
...
function ce() {
  ...
  return `${1 === e ? "rgb(" : "rgba("}${ue(this.r)}, ${ue(this.g)}, ${ue(
    this.b
  )}${1 === e ? ")" : `, ${e})`}`;
}
function le(e) {
...
function pe(e) {
  ...
  if ((e instanceof H || (e = ae(e)), !e)) return new he();
  ...
  j(
    ...
    function (e, t, n, a) {
      return 1 === arguments.length
        ? ie(e)
        : new re(e, t, n, null == a ? 1 : a);
    },
    U(H, {
      brighter(e) {
        return (
          (e = null == e ? z : Math.pow(z, e)),
      ...
      formatHex: se,
      formatHex8: function () {
        return `#${de(this.r)}${de(this.g)}${de(this.b)}${de(
    ...
    U(H, {
      ...
      rgb() {
        var e = (this.h % 360) + 360 * (this.h < 0),
          ...
          o = 2 * n - a;
        return new re(
          ve(e >= 240 ? e - 240 : e + 120, o, a),
          ve(e, o, a),
          ve(e < 120 ? e + 240 : e - 120, o, a),
          this.opacity
        );
      },
      clamp() {
...
const Ee = Math.PI / 180,
  ...
  Le = 3 * we * we;
function Se(e) {
  if (e instanceof xe) return new xe(e.l, e.a, e.b, e.opacity);
  if (e instanceof Pe) return Ae(e);
  ...
  var t,
    ...
    o = $e(e.g),
    i = $e(e.b),
    r = Te((0.2225045 * a + 0.7168786 * o + 0.0606169 * i) / 1);
  return (
    a === o && o === i
      ? (t = n = r)
      : ((t = Te((0.4360747 * a + 0.3850649 * o + 0.1430804 * i) / 0.96422)),
        (n = Te((0.0139322 * a + 0.0971045 * o + 0.7141733 * i) / 0.82521))),
...
function Te(e) {
  return e > 0.008856451679035631 ? Math.pow(e, 1 / 3) : e / Le + be;
}
function Ne(e) {
...
function qe(e) {
  if (e instanceof Pe) return new Pe(e.h, e.c, e.l, e.opacity);
  if ((e instanceof xe || (e = Se(e)), 0 === e.a && 0 === e.b))
...
function Ae(e) {
  if (isNaN(e.h)) return new xe(e.l, 0, 0, e.opacity);
  var t = e.h * Ee;
...
j(
  ...
  U(H, {
    ...
    rgb() {
      ...
      return new re(
        ke(
          3.1338561 * (t = 0.96422 * Ne(t)) -
            1.6168667 * (e = 1 * Ne(e)) -
            0.4906146 * (n = 0.82521 * Ne(n))
        ),
        ke(-0.9787684 * t + 1.9161415 * e + 0.033454 * n),
        ke(0.0719453 * t - 0.2289914 * e + 1.4052427 * n),
        this.opacity
      );
    },
  })
...
function Oe(e, t) {
  let n = {};
  return (
    (n.unknown = e.closest("[data-schemeunknown]").dataset.schemeunknown),
    e.dataset.schemestart && e.dataset.schemeend
      ? ((n.start = e.dataset.schemestart),
        ...
        (Re("SchemeScale").querySelector(`input[value="${n.scale}"]`).checked =
          !0),
        Re("SchemeZero").closest("div").classList.add("Hide"),
        (Re("SchemeScale").querySelector("#Logarithmic").disabled =
          e.dataset.schemezero),
        e.dataset.schemezero &&
          ((n.zero = e.dataset.schemezero),
          (Re("SchemeZero").value = De(n.zero).formatHex()),
          Re("SchemeZero").closest("div").classList.remove("Hide")),
        (function (e, t, n) {
          if (n) {
            const a =
              (Number(Re("Kelvin").value) / Number(Re("Kelvin").max)) * 100;
            Re(
              "RangeGradient"
            ).style.background = `linear-gradient(to bottom, ${e}, ${n} ${a}%, ${t})`;
          } else
            Re(
              "RangeGradient"
            ).style.background = `linear-gradient(to bottom, ${e}, ${t})`;
        ...
        (function (e, t) {
          const n = {
            ...
            a = e.map(n),
            o = Math.min(
              ...a.filter((e) => !isNaN(e)).map((e) => (isFinite(e) ? e : 0))
            ),
            i = Math.max(
              ...a.filter((e) => !isNaN(e)).map((e) => (isFinite(e) ? e : 0))
            );
      ...
      : e.dataset.schemevalues
      ? (function (e, t) {
          const n = new Map(
            e.dataset.schemevalues.split(",").map((e) => e.split("="))
          );
...
async function Ue(e) {
  ...
  n.forEach((e, t) => {
    ...
    (t.style.backgroundColor = n),
      _e.test(n) &&
        (n = window.getComputedStyle(t).getPropertyValue(_e.exec(n)[1]));
    const o = (function (e) {
      if ("" === e) return e;
      const t = 0.1791;
      function n(e) {
...
function Ze() {
  ...
  return { l: o, m: e - o - 1, n: n + o + 1 };
}
function Je() {
  const e = Ze.call(this),
    t = document.querySelector(".Active");
  t && t.classList.remove("Active"), this.classList.add("Active"), et(e);
}
async function Qe(e) {
  const t = await i.value(e, void 0, "quantum");
  Je.call(
    (function (e) {
      return Ke("ConfigBlocks").children[e.l].children[e.n - e.l - 1].children[
        e.m + e.l + 1
      ];
    })(t)
  );
...
const et = ze((e) => {
  const t = new CustomEvent("drawOrbital", { detail: e });
...
async function tt(e) {
  ...
  !(function (e) {
    ...
    function n(e, t) {
      ...
      for (let a = 0; a < 2 * n; a++)
        a < n
          ? e[a % n].classList.toggle("One", t > a)
          : e[a % n].classList.toggle("Two", t > a);
    }
    const a = new Map(e.map((e) => [e.substr(0, 2), t(e)]));
    Ke("ConfigBlocks")
      .querySelectorAll("#ConfigBlocks > div > div")
      .forEach((e) => {
...
Ke("Ptable").addEventListener("hoverElement", (e) => {
  cancelAnimationFrame(Xe), (Xe = requestAnimationFrame(() => tt(e)));
}),
  ...
  Ke("ConfigBlocks")
    ...
    .forEach((e) => {
      (e.tabIndex = 0), e.addEventListener("focus", Je);
    });
...
function lt(e) {
  ...
  at("Ptable").classList.add("Fanned", "Tilt"),
    fetch(n)
      ...
      .then((t) => dt.call(e.target, t))
      .catch((e) => {
        reportError(e), st();
      })
      .finally(() => {
        e.target.classList.remove("Loading"), ct();
      });
}
function ut(e) {
  if (e.target.classList.contains("Tope")) return;
...
function dt(e) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    ...
    s
      .querySelector("abbr")
      .insertAdjacentText("beforeend", a.children[1].textContent),
      ...
      a.addEventListener("pointerleave", () => {
        document.querySelector("ol > li.Active.Tope") ||
          (it = setTimeout(ht, 300));
      });
  }
  !(function (e, t) {
    function n(e) {
      cancelAnimationFrame(rt), (rt = requestAnimationFrame(() => s(e)));
    }
    ...
    function s(e) {
      ...
      r &&
        (r.style.setProperty("--shiftX", `${t}px`),
    ...
    document
      .querySelectorAll(`ol > li.Tope[data-atomic="${t}"]`)
      .forEach((e) =>
        e.style.setProperty(
          "--offset",
          e.style.getPropertyValue("--offsetFinal")
        )
      ),
    at("Isotope").dispatchEvent(i.changeProperty);
}
async function mt(e) {
  e.target.classList.contains("Tope") &&
    (ot.className = await i.value(
      e.target.dataset.atomic,
      e.target.dataset.neutrons,
      "decaymode"
    ));
}
function pt() {
...
function gt(e) {
  const t = We(
    Number(e.dataset.atomic),
    at("Wide").checked ? i.table_map.wide : i.table_map.traditional
  );
  !1 !== t &&
    function (e, t) {
...
(ot.dataset.default = ot.className),
  document
    .querySelectorAll("#DecayModes > div")
    .forEach((e) => e.addEventListener("pointerenter", pt)),
  ...
  (function () {
    const e = at("Isotope").querySelectorAll(
        ':scope > input:not([value="isotopes"])'
      ),
  ...
  i.atomic_map.forEach((n) => {
    n.setAttribute("draggable", e),
      e
        ...
        : (n.ondragstart = n.ondragend = null);
  });
}
function Ct(e) {
  const t = e.dataTransfer
      ? Number(e.dataTransfer.getData("text"))
      : Number(e.target.dataset.atomic),
...
async function xt(e) {
  function t(e, t) {
    if (
      ((e.dataset.count = Number(e.dataset.count) + t), e.dataset.count <= "-1")
    ) {
      Ct({ target: e });
  ...
  if (o);
    ...
    a
      ...
      .addEventListener("click", (e) =>
        t(e.currentTarget.closest("[data-atomic]"), 1)
      ),
      a
        .querySelector(".Down")
        .addEventListener("click", (e) =>
      ...
      bt &&
        ...
        (o.ondragstart = function (e) {
          e.dataTransfer.setData(
            "text",
            this.closest("[data-atomic]").dataset.atomic
          ),
            e.dataTransfer.setData("element", ""),
            (document.ondrop = Ct),
...
function kt(e) {
  for (; yt.lastChild; ) yt.lastChild.remove();
  Object.keys(e).length || (e.counts = []);
  new Map([...i.atomic_map].map(([t, n]) => [n, e.counts[t]])).forEach((e, t) =>
    i.insert(t.dataset.atomic, "compounds", e)
  ),
...
function $t(e, t = [], n, a) {
  function o() {
    ...
    for (let t = 0; t < Lt.length; t++) e.includes(Lt[t]);
    wt = this;
  }
  ...
  t.forEach((e) => {
    const t = document.createElement("li"),
      ...
      r = document.createRange().createContextualFragment(
        (function (e) {
          let t = e;
          return (
            (t = t.replace(/([A-Z][a-z]?)(\d+)/g, "$1<sub>$2</sub>")),
    ...
    for (let e = 0; e < s.length; e++)
      if (0 === e || ("" === c[0] && "" !== c[e]) || 1 === n) {
        ...
        "" !== c[e] &&
          (n.href = `//en.wikipedia.org/wiki/${encodeURIComponent(
            c[e].replace(/ /g, "_")
          )}`),
          (n.textContent = s[e]),
          t.appendChild(n);
    ...
    e.appendChild(i),
    yt.getElementsByTagName("li").length < n &&
      "IntersectionObserver" in window &&
      ((r = e.lastElementChild),
      new IntersectionObserver(Pt, { root: yt, threshold: 0.5 }).observe(r));
}
function qt(e, t) {
...
function Pt(e) {
  e[0].isIntersecting &&
    (this.disconnect(), qt(yt.getElementsByTagName("li").length, Nt));
}
function At() {
  const e = [...document.querySelectorAll("#CompoundDragTarget > div")].map(
    (e) => e.dataset.symbol + (Number(e.dataset.count) || "")
  );
  yt.classList.add("Dim"), (yt.dataset.query = e.sort().join("")), qt(0, kt);
}
const It = {
    activate: function () {
      var e;
      if (
        (document.documentElement.classList.add("Compound"),
        (e = Et("CompoundDragTarget")),
        new MutationObserver(At).observe(e, { childList: !0 }),
        At(),
...
function _t(e) {
  ...
  const a = { Reset: O, Property: He, Electron: nt, Isotope: vt, Compound: It },
    o = n(e.oldURL),
    r = t(o[0]),
    s = n(e.newURL);
  let c = t(s[0]);
  r !== c &&
    (("Reset" !== r && "Reset" !== c) ||
      (document.documentElement.classList.add("SmoothResize"),
      document
        .getElementsByTagName("aside")[0]
        .addEventListener("transitionend", jt)),
    a[c]
      ? (a[r] && a[r].cleanup(), (Mt(`${c}Tab`).checked = !0), a[c].activate())
      : (c = document
          .querySelector('header input[name="Tab"]:checked')
          .id.replace(/Tab$/, "")));
  const l = [Ft(c)];
  let u = [...Mt(c).querySelectorAll(':scope > input[type="radio"]')].find(
    (e) => Ot(Dt(e)) === decodeURIComponent(s[1])
  );
  u && !u.disabled
    ? (u.checked = !0)
    : ((u = Mt(c).querySelector("input:enabled:checked")),
      u
        ? (u.checked = !0)
        : (Mt(c).querySelector("input:enabled").checked = !0),
      (u = Mt(c).querySelector("input:enabled:checked"))),
    l.push(Dt(u));
  ...
  if (d) {
    ...
    s[2] &&
      (e = [...d.options].find(
        (e) => Ot(e.textContent) === decodeURIComponent(s[2])
      )),
      e ? (e.checked = !0) : (e = d.options[d.selectedIndex]),
      (d.value = e.value),
      l.push(e.textContent);
  }
  o.join("/") !== s.join("/") && (Ht(l), Mt(c).dispatchEvent(i.changeProperty));
}
function Ft(e) {
...
function Bt(e) {
  ...
  a && n.push(a.options[a.selectedIndex].text),
    _t({ oldURL: window.location.hash, newURL: Ut(n) });
}
function Dt(e) {
...
function Ot(e) {
  return ((t = e),
  t.replace(/[^\s]+/g, (e) => e.replace(/^./, (e) => e.toUpperCase()))).replace(
    /\s/g,
    ""
  );
  var t;
...
function jt(e) {
  e.target === this &&
    (this.removeEventListener("transitionend", jt),
...
function Ht(e) {
  ...
  return (
    ...
    (function (e) {
      e.unshift(Rt), (document.title = e.join(" - "));
    })(e),
    t
  );
}
!(function () {
  ...
  "" === window.location.hash && "#" !== window.location.href.slice(-1)
    ? Ht([Ft("Property")])
    : window.location.hash === e ||
      _t({ oldURL: e, newURL: window.location.hash }),
    document
      .querySelectorAll('header input[name="Tab"]')
      .forEach((e) =>
        e.addEventListener("click", () =>
          e.nextElementSibling.querySelector("a").click()
        )
      ),
...
function Xt(e) {
  document.querySelector("ol > li.Active.Tope") ||
    e.target.closest("li").dispatchEvent(i.hoverElement);
}
function Gt(e, t) {
  zt("Ptable").classList.toggle("Hover", t), [...e].forEach((e) => Yt(e, t));
}
function Yt(e, t) {
  t
    ? (e.addEventListener("pointerenter", Xt),
      e.addEventListener("focusin", Xt))
    : (e.removeEventListener("pointerenter", Xt),
      e.removeEventListener("focusin", Xt));
}
async function Zt(e) {
  if (!Kt || "BUTTON" === e.relatedTarget?.nodeName) return;
  const t = await i.value(e.target.dataset.atomic, void 0, "compounds");
  let n;
  document.documentElement.classList.contains("Compound") &&
    !t &&
    document.querySelectorAll("ol > li.Active").forEach((e) => {
      Jt({ currentTarget: e }), an.call(e);
    });
  const a = Number(
      getComputedStyle(document.querySelector("article")).getPropertyValue(
        "--lock"
      )
    ),
  ...
  for (
    ;
    (n = document.querySelectorAll(`ol > li.Active${o}`)),
      n.length && n.length >= a;

  )
    Jt({ currentTarget: n[0] });
  a > 0
    ? (function (e) {
...
function Jt(e) {
  ...
  t.classList.remove("Active"),
    ...
    Wt &&
      (t.addEventListener("pointerleave", an),
...
function tn(e) {
  "Enter" === e.key &&
    (this.classList.contains("Active")
      ? Jt({ currentTarget: this })
      : Zt({ target: this, force: !0 }));
}
function nn(e) {
  "Escape" === e.key &&
    this.classList.contains("Active") &&
